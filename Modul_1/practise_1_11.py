...
print(f"Время полета Модель 1: {flight_duration_model_1}")
print(f"Время полета Модель 2: {flight_duration_model_2}")

model_1_battery_life = (telemetry_model_1['battery_life'].iloc[0] -
                        telemetry_model_1['battery_life'].iloc[-1])
model_2_battery_life = (telemetry_model_2['battery_life'].iloc[0] -
                        telemetry_model_2['battery_life'].iloc[-1])

print(f"Расход батареи Модель 1: {model_1_battery_life}%")
print(f"Расход батареи Модель 2: {model_1_battery_life}%")
...
print(f"Дистанция для Модели 1: {dist_model_1}")
print(f"Дистанция для Модели 2: {dist_model_2}")

eff_model_1 = dist_model_1 / model_1_battery_life
eff_model_2 = dist_model_2 / model_2_battery_life
...
plt.title('Сравнение эффективность дронов')
plt.savefig("eff_drons.png")
