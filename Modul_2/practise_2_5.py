...
class SingleEngine(Engine):
    ...
    def set_rotation_speed(self, speed: int):
        ...
        print(f"Скорость вращение одного двигателя установлена на {speed} оборотов в минуту")
...
class TripleEngine(Engine):
    ...
    def set_rotation_speed(self, speed: int):
        ...
        print(f"Скорость вращение трех двигателей установлена на {speed} оборотов в минуту")
        return power # возвращаем потребляемую мощность
...
class QuadEngine(Engine):
    ...
    def set_rotation_speed(self, speed: int):
        ...
        print(f"Скорость вращение четырех двигателей установлена на {speed} оборотов в минуту")
        return power # возвращаем потребляемую мощность
...
if __name__ == "__main__":
    ...
    standart_drone = StandardDrone(single_engine)
